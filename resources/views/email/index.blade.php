...
<div id="containering">
  ...
  <div id="content">
    <div id="left_content">
      <div class="menu">
        <ul>
          <li class="{{($route == 'register.vendor')? 'current' : ''}}"><a href="{{route('register.vendor')}}" >Vendor Register</a></li>
                        ...
                        <form action="{{route('send.email')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-12 ">
                                    ...
                                    <input style="background-color: #0A2035; color:white;" type="email" name="sendemail" id="" class="form-control">
                                </div>


                                <div class="col-md-12">
                                    <label for="">Subject</label>
                                    <input style="background-color: #0A2035; color:white;" type="text" name="sub" id="" class="form-control">
                                </div>
        
                                <div class="col-md-12 mt-3">
                                    <label for="">Description</label>
                                    <textarea style="background-color: #0A2035; color:white;" name="desc" id="" class="form-control" cols="30" rows="2"></textarea>
                                </div>

                                <div class="col-md-12 mt-2">
                                    <label for="">Attach Receipt</label>
                                    <input style="background-color: #0A2035; color:white;" type="file" name="attach" id="" class="form-control">
                                </div>
